...
const options = {
  renderNode: {
    ...
    [BLOCKS.HEADING_2]: TextComponent({ component: 'h2', variant: 'h5' }),
    [BLOCKS.HEADING_3]: TextComponent({ component: 'h3', variant: 'h6' }),
    [BLOCKS.HEADING_4]: TextComponent({ component: 'h4', variant: 'subtitle2' }),
